...
/**
 * Walks {@linkplain io.github.cvs0.bytecode.JarMapping#getProgramClasses() program classes} and their methods, including
 * classes that only have instructions on the backing {@link org.objectweb.asm.tree.ClassNode} when the
 * {@link io.github.cvs0.bytecode.member.ProgramMethod} map is empty.
 */
